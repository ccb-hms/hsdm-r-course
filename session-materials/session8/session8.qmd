---
title: "Week 8: Exploring survey data"
...
# Data
Let's go back to the raw NHANES data, just after we combined the three cycles. 
...
```{r}
## Re-leveling the diabetes variable to be in a better order for plotting any analysis
wt_nhanes <- wt_nhanes %>%
