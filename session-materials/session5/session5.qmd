...
save(all_nhanes, file = "processed_beheshti.RData")
```
...
Recreate as much of Table 1a. from the Beheshti paper as you can. For now, this will mean excluding Chi-squared test results.
