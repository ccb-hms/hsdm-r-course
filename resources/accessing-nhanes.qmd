...
We can define a quary to NHANES by creating a list of column names for each table we're interested in. 
It is reccomended to only get a single servey cycle with a single query. 
